    ...
    const paddings = sortCx({
        sm: {
            input: cx(
                ...
                hasLeading &&
                    'group-has-[&>select]:pr-9 group-has-[&>select]:pl-2',
                hasTrailing &&
                    (prefix
        ...
        md: {
            input: cx(
                // Apply padding styles when select element is passed as a child
                hasLeading &&
                    'group-has-[&>select]:pr-9 group-has-[&>select]:pl-2.5',
                hasTrailing &&
                    (prefix
                        ? 'group-has-[&>select]:pr-6 group-has-[&>select]:pl-0'
                        : 'group-has-[&>select]:pr-6 group-has-[&>select]:pl-3'),
        ...
        lg: {
            input: cx(
                // Apply padding styles when select element is passed as a child
                hasLeading &&
                    'group-has-[&>select]:pr-9.5 group-has-[&>select]:pl-3',
                hasTrailing &&
                    (prefix
                        ? 'group-has-[&>select]:pr-6 group-has-[&>select]:pl-0'
                        : 'group-has-[&>select]:pr-6 group-has-[&>select]:pl-3'),
            ...
            {({ isDisabled, isInvalid, isRequired }) => (
                <>
                    {label && (
                        <Label
                            isRequired={
                                hideRequiredIndicator ? false : isRequired
                            }
                        >
                            {label}
                        </Label>
